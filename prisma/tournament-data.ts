...
export const TEAMS: TeamSeed[] = [
  // Group A
  { name: "Mexico", code: "MX", group: "A", players: ["Santiago Giménez", "Raúl Jiménez", "Edson Álvarez"] },
  { name: "South Korea", code: "KR", group: "A", players: ["Son Heung-min", "Lee Kang-in", "Hwang Hee-chan"] },
  { name: "South Africa", code: "ZA", group: "A", players: ["Lyle Foster", "Percy Tau", "Themba Zwane"] },
  ...
  { name: "Bosnia and Herzegovina", code: "BA", group: "B", players: ["Edin Džeko", "Ermedin Demirović", "Smail Prevljak"] },
  // Group C
  ...
  { name: "Haiti", code: "HT", group: "C", players: ["Frantzdy Pierrot", "Duckens Nazon", "Danley Jean Jacques"] },
  // Group D
  ...
  { name: "Ecuador", code: "EC", group: "E", players: ["Enner Valencia", "Moisés Caicedo", "Kendry Páez"] },
  { name: "Ivory Coast", code: "CI", group: "E", players: ["Sébastien Haller", "Simon Adingra", "Franck Kessié"] },
  { name: "Curaçao", code: "CW", group: "E", players: ["Leandro Bacuna", "Tahith Chong", "Juninho Bacuna"] },
  // Group F
  ...
  { name: "Tunisia", code: "TN", group: "F", players: ["Hannibal Mejbri", "Youssef Msakni", "Naïm Sliti"] },
  ...
  { name: "New Zealand", code: "NZ", group: "G", players: ["Chris Wood", "Ben Waine", "Marko Stamenić"] },
  // Group H
  ...
  { name: "Cape Verde", code: "CV", group: "H", players: ["Ryan Mendes", "Garry Rodrigues", "Jamiro Monteiro"] },
  // Group I
  ...
  { name: "Iraq", code: "IQ", group: "I", players: ["Aymen Hussein", "Ali Jasim", "Mohanad Ali"] },
  // Group J
  { name: "Argentina", code: "AR", group: "J", players: ["Lionel Messi", "Julián Álvarez", "Lautaro Martínez"] },
  { name: "Austria", code: "AT", group: "J", players: ["Marko Arnautović", "Christoph Baumgartner", "Marcel Sabitzer"] },
  { name: "Algeria", code: "DZ", group: "J", players: ["Riyad Mahrez", "Amine Gouiri", "Islam Slimani"] },
  ...
  { name: "DR Congo", code: "CD", group: "K", players: ["Yoane Wissa", "Cédric Bakambu", "Silas Katompa"] },
  // Group L
