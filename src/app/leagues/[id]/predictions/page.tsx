      ...
      <div className="space-y-4 lg:sticky lg:top-32 lg:self-start">
        ...
        <Card>
          <CardContent className="space-y-2 p-5 text-sm">
            ...
            <div className="flex justify-between"><span className="text-muted-foreground">Power Pick <span className="text-[10px]">(1 / matchday · Power Pick tab)</span></span><span className="font-semibold text-gold">×1.5</span></div>
